...
```
```{r, vincent bundock, echo=TRUE}
dem2 <- ifelse(presidents$dem == 1, "democrat", "republican")
rep2 <- ifelse(presidents$rep == 1, "republican", "democrat")
presidents <- presidents %>%
cbind(presidents,dem2,rep2)
str(presidents)
#mutate(presidents, party_id = dem2 + rep2) # this is not working for me!!!!
str(presidents)
#my.table <- table(presidents$vote,presidents$party_id); my.table
```
