...
*  This is nearly identical to the OLS model.  On average a one unit change in per-capita GDP correlates to a 0.000197 unit change in voter turnout.
...
In the MLE model, asymptotic consistency--rather in this case inconsistency--is responsible for the variation in standard errors.  In the OLS model bias causes the variation in standard errors.  In the OLS model, they all remain nearly identical because the data does not have bias.
