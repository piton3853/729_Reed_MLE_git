...
```{r, set working dir and load data, echo=TRUE, eval=TRUE}
...
```{r descriptive statistics stargazer, echo=FALSE, eval=FALSE, results='asis'}
...
```{r independent variable plot, include=TRUE, echo=TRUE, eval=TRUE}
...
```{r binomial model, echo=TRUE, eval=TRUE}
# run binomial, show results
model_1l <-glm(voted~age+income+
...
```{r logit model stargazer - 2, include=F, echo=F, eval=F, results='asis'}
summary(model_1l)
...
```{r logit predicted probabilities, include=T, echo=T, eval=T}
...
```{r probit model - probit link, echo=FALSE, eval=FALSE}
# run probit, show results
...
```{r probit model stargazer - 2, echo=FALSE, eval=FALSE, results='asis'}
#summary(model_1p)
...
```{r probit predicted probabilities - automatic, echo=FALSE, eval=FALSE}
# generate predicted probabilities automatically
...
```{r characterize the simulations - S, echo=FALSE, eval=FALSE, include=FALSE, cache=FALSE}
...
```{r violin plot, include=FALSE, echo=FALSE, eval=FALSE, cache=FALSE}
